                ...
                <div class="mdl-card mdl-cell mdl-cell--12-col-desktop mdl-cell--6-col-tablet mdl-cell--4-col-phone">
                    ...
                    <div class="mdl-card__supporting-text">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label ">
                            <input name="email-input" class="mdl-textfield__input" type="text" id="input">
                            <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="input">Select POI (This should be a pull down option)</label>
                        </div>
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input name="email-input" class="mdl-textfield__input" type="text" id="cost">
                            <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="cost">Cost</label>
                        </div>

                        <div class="mdl-textfield mdl-textfield--bar--red mdl-js-textfield mdl-textfield--floating-label">
                            <input name="email-input" class="mdl-textfield__input" type="text" id="partyCount">
                            <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="partyCount">Number of people</label>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input name="email-input" class="mdl-textfield__input" type="text" id="date">
                            <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="date">Date (DD/MM/YYYY)</label>
                        </div>
                        <div>
                        <a target="_blank" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--red-900 mdl-color-text--accent-contrast">
                            Submit
                        </a>
                            <!--<a target="_blank" class="mdl-button mdl-js-button mdl-button&#45;&#45;raised mdl-js-ripple-effect mdl-color-text&#45;&#45;accent-contrast">-->
                                <!--Submit-->
                            <!--</a>-->
                        </div>
                    </div>
