...
3. Access your homepage via http://georgia.eng.utah.edu:8080/~cs5530ux
(replace x with your user id, e.g., cs5530u01).
...
You can then access your abc.jsp page from http://georgia.eng.utah.edu:8080/~cs5530ux/abc.jsp. And inside your abc.jsp page, you can import your java class (see orders.jsp for an example).
