                    ...
                    <div class="mdl-card__supporting-text">
                        ...
                        <div id="PriceRange">
                            ...
                            <div style="width:100px;"  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input name="min" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="min">
                                <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="min">Min Price</label>
                                <span class="mdl-textfield__error">Input must be a number</span>
                            </div>

                            <div style="width:100px;"  class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input name="max" class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="max">
                                <label class="mdl-textfield__label input_label mdl-color-text--red-900" for="max">Max Price</label>
                                <span class="mdl-textfield__error">Input must be a number</span>
                            </div>
                        </div>
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input name="Category" class="mdl-textfield__input" type="text" id="Category">
                            <label class="mdl-textfield__label input_label" for="Category">Category</label>
                        </div>

                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input name="Address" class="mdl-textfield__input" type="text" id="Address">
                            <label class="mdl-textfield__label input_label" for="Address">Address (City/State)</label>
                        </div>


                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input name="keywords" class="mdl-textfield__input" type="text" id="keywords">
